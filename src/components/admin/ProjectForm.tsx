    ...
    <form action={formAction} className="flex max-w-2xl flex-col gap-5">
      <div className="flex flex-col gap-1.5">
        ...
        <input
          ...
          placeholder="School Values Tours"
      ...
      <div className="grid grid-cols-2 gap-5">
        <div className="flex flex-col gap-1.5">
          ...
          <input
            ...
            placeholder="Ongoing · Nationwide"
            className={inputClass}
          />
        </div>
      ...
      <ImageUploadField name="image" label="Photo" defaultImage={defaultValues?.img} />
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <input
          ...
          placeholder="A school classroom"
          className={inputClass}
        />
      </div>
